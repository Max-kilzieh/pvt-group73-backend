...
public class HttpRequestTest {
    ...
    @Test   //Skrapan, götgatan
    public void trashCansWithinHundredMeterFromSkrapan() {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/trash-cans?lat=59.31805206&lng=18.06298083&distance=100",
    ...
    @Test   //Kista T-bana
    public void trashCansWithinTwentyMeterFromKistaTrainStation() {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/trash-cans?lat=59.40332696500667&lng=17.942350268367566&distance=20",
