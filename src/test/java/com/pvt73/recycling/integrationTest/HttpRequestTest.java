...
public class HttpRequestTest {
    ...
    public void wasteBinsWithinHundredMeterFromSkrapan() {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/waste_bins/nearby?latitude=59.31805206&longitude=18.06298083",
    ...
    public void wasteBinsWithinTwentyMeterFromKistaTrainStation() {
        assertThat(this.restTemplate.getForObject("http://localhost:" + port + "/waste_bins/nearby?latitude=59.40332696500667&longitude=17.942350268367566&distance=20",
